  ...
  rows: [
    {
      ...
      type: {
        ...
        template: function (obj) {
          ...
          return `<div>
                          <img id='imgItem ${obj.user_name}' src='${
            "/img/" + obj.img
          }' onerror="this.onerror=null; this.src='${service.IMG_DEFAULT}'">
                          <div class='info'>
						  <div class="number" style='opacity: ${displayUsrNo}'>${obj.mssv}</div>
						  <div class='row name'>${obj.user_name}</div>
                            <div class='row col'>
                               <div class='start-date'>${
                                 obj.role.role_name === undefined
                                   ? "Undefined"
                                   : obj.role.role_name
                               }</div>
                            </div>
...
const formRight = () => ({
  ...
  name: "formRight",
  maxWidth: 800,
  rows: [formDetailRight(), tableDevice()],
});
